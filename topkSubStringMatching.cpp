...
int main(int argc, const char* argv[])
{
	...
	ofstream fout((stemp + "_subString").c_str());
	...
	for (int j = 0; j < tk.size(); j++) {
		...
		ofstream fdetail((stemp + "_subString_" + changeI2S(gl_topk)).c_str());
